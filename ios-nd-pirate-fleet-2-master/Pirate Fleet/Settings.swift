...
struct Settings {
    ...
    struct Titles {
        static let HumanHitMine = "Boom!"
        static let ComputerHitMine = "Ka-Boom!"
        static let HumanHitMonster = "Yikes!"
        static let ComputerHitMonster = "Chomp!"
    }
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've awakend a seamonster! This giant marine reptile is comin' for your ships!"
        static let ComputerHitMonster = "The computer has hit a sea monster! You'll get a guaranteed hit."
